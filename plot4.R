...
png("plot4.png", width=480, height=480) ## Start PNG file

## Arranging plots in a 2x2 dimension.
par(mfcol = c(2,2))

## Introducing plot [1,1].
...
legend("topright", c("Sub_Metering_1", "Sub_Metering_2", "Sub_Metering_3"),
       col = c("black", "red", "blue"),cex = 0.2, lty= 1, lwd = 2.5)

## Introducing plot [1,2].
with(power_subdata, plot(DateTime, Voltage, xlab = "datetime", ylab = "Voltage", type = "l"))

## Introducing plot [2,2].
GlobalReactivePower = as.numeric(as.character(power_subdata$Global_reactive_power))
with(power_subdata, plot(DateTime,GlobalReactivePower, xlab = "datetime", 
